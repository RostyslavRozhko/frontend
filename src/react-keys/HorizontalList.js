...
class HorizontalList extends Focusable {
  ...
  render() {
    const { focusId, navDefault, onFocus, onBlur, onEnterDown, rootNode, forceFocus, retainLastFocus, focusableId, height, ...props } = this.props;
    return <div style={{display: "flex", alignItems: "center", height}} {...props} />
  }
}
